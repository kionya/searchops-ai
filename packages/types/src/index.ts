...
export const SearchOpsEnvSchema = z.object({
  ...
  SEARCHOPS_GEO_CHATGPT_API_KEY: z.string().min(1).optional(),
  SEARCHOPS_GEO_CHATGPT_MODEL: z.string().min(1).optional(),
  SEARCHOPS_GEO_CLAUDE_API_KEY: z.string().min(1).optional(),
  SEARCHOPS_GEO_CLAUDE_MODEL: z.string().min(1).optional(),
  SEARCHOPS_GEO_GEMINI_API_KEY: z.string().min(1).optional(),
  SEARCHOPS_GEO_GEMINI_MODEL: z.string().min(1).optional(),
  SEARCHOPS_GEO_PERPLEXITY_API_KEY: z.string().min(1).optional(),
  SEARCHOPS_GEO_PERPLEXITY_MODEL: z.string().min(1).optional(),
