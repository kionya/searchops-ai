...
const demoReadinessItems = [
  ...
  createDemoItem("dead-letter-replay-ux", "hardening", "Queue별 idempotent replay 운영 UX", "manual_followup"),
  createDemoItem("backup-restore-rehearsal", "hardening", "Backup/restore drill 실제 리허설", "manual_followup"),
  createDemoItem("migration-ci-check", "hardening", "Migration deploy CI/CD check", "manual_followup"),
  createDemoItem("ops-dashboard-polish", "hardening", "운영자용 ops dashboard polish", "manual_followup"),
